...
function WorkOrderTicket({ details }: { details: OrderDetailsForWorkOrder }) {
    return (
        <>
            ...
            <div className="bg-white text-black p-1 max-w-[48mm] mx-auto work-order-printable font-black" style={{ fontWeight: '700', fontFamily: '"Segoe UI", "Roboto", "Arial", sans-serif' }}>
                <header className="text-center mb-1" style={{ fontWeight: '700' }}>
                    <LogoComponent className="mx-auto w-8 h-8 rounded-full mb-1" />
                    <h1 className="text-sm font-black" style={{ fontWeight: '700', color: '#000', fontFamily: '"Segoe UI", "Roboto", "Arial", sans-serif' }}>Levist Uniforms</h1>
                    <p className="text-[10px] leading-tight font-black" style={{ fontWeight: '700', color: '#000', fontFamily: '"Segoe UI", "Roboto", "Arial", sans-serif' }}>Matamoros, Tamaulipas</p>
                    <p className="mt-1 font-black text-xs" style={{ fontWeight: '700', color: '#000', fontFamily: '"Segoe UI", "Roboto", "Arial", sans-serif' }}>Orden de Trabajo</p>
                    <p className="font-black text-xs" style={{ fontWeight: '700', color: '#000', fontFamily: '"Segoe UI", "Roboto", "Arial", sans-serif' }}>PRODUCCIÓN / TALLER</p>
                </header>
                ...
                {details.school_name && (
                    <section className="my-1 p-1 border-2 border-black rounded-sm bg-blue-50" style={{ fontWeight: '700' }}>
                        <p className="text-center font-black text-xs uppercase" style={{ fontWeight: '700', color: '#000', fontFamily: '"Segoe UI", "Roboto", "Arial", sans-serif' }}>ESCUELA:</p>
                        <p className="text-center font-black text-sm uppercase" style={{ fontWeight: '700', color: '#000', fontFamily: '"Segoe UI", "Roboto", "Arial", sans-serif' }}>{details.school_name}</p>
                    </section>
                )}

                {details.embroidery_notes && (
                    <section className="my-1 p-1 border border-black rounded-sm bg-white" style={{ fontWeight: '700' }}>
                        <h2 className="font-black text-xs mb-0.5" style={{ fontWeight: '700', color: '#000', fontFamily: '"Segoe UI", "Roboto", "Arial", sans-serif' }}>Instrucciones:</h2>
                        <p className="font-black text-xs whitespace-pre-wrap" style={{ fontWeight: '700', color: '#000', fontFamily: '"Segoe UI", "Roboto", "Arial", sans-serif' }}>{details.embroidery_notes}</p>
                    </section>
                )}
